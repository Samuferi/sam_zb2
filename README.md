...
ROS 2 pacage template, to get started, use template by clicking on the Green button labeled [`Use this template`](https://github.com/Samuferi/sam_zb2/generate) / [`Create new repository`](https://github.com/Samuferi/sam_zb2/generate). 
...
- `sam_zb2` >> `cool_ros2_package` (the folder was already renamed after `Use this template`)
- `Samuferi` >> `mycoolusername`
